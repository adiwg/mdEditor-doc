...
* **Start and End date:** Refers to when the money was allocated and distributed. The time period can be _start date only, end date only, _or_ start and end date_.
